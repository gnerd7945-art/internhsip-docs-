...
12)  in operator/member function , cpp looks at left and right side of it as arg( compiler rewrites function defination and make 1st argument as this), if operator defined in a class , then left side is implictly the object of that class(this). this is nothing but address of object and address and pointer are same thing  
